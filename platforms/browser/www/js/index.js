...
if(nextTab<5){
$('<li id="liTab_'+(nextTab+1)+'" onclick="selectCurrTab(this,event)" role="presentation" class="nav-item eduCls"><a role="tab" aria-selected="true" aria-setsize="2" aria-posinset="1" target="_self" href="#" class="nav-link " id="tab_'+nextTab+'"><button class="close closeTab" type="button" onclick="deleteTab(this)">×</button>Select Degree</a></li>').appendTo('#tabs');
...
$("#tabs_2").find('li').removeClass('eduClsActivePage3');
      $('<li id="liPage3_'+(nextTab+1)+'" onclick="selectCurrTab_2(this,event)" role="presentation" class="nav-item eduClsPage3 eduClsActivePage3"><a role="tab" aria-selected="true" aria-setsize="2" aria-posinset="1" target="_self" href="#" class="nav nav-tabs " id="tabPage3__'+nextTab+'"><button class="close closeTab" type="button" onclick="deleteTab2(this)">×</button>Relevant Exp.</a></li>').appendTo('#tabs_2');
...
$("#tabs_4").find('li').removeClass('eduClsActivePage3Tab3');
      $('<li id="liTab3Page3_'+(nextTab+1)+'" onclick="selectCurrTab_4(this,event)" role="presentation" class="nav-item eduClsPage3Tab3 eduClsActivePage3Tab3"><a role="tab" aria-selected="true" aria-setsize="2" aria-posinset="1" target="_self" href="#" class="nav nav-tabs " id="tabPage3Tab3__'+nextTab+'">Tab '+(nextTab+1)+'<button class="close closeTab" type="button" onclick="deleteTab4(this)">×</button></a></li>').appendTo('#tabs_4');
...
$("#tabs_5").find('li').removeClass('eduClsActivePage4Tab2');
      $('<li id="liTab2Page4_'+(nextTab+1)+'" onclick="selectCurrTab_5(this,event)" role="presentation" class="nav-item eduClsPage4Tab2 eduClsActivePage4Tab2"><a role="tab" aria-selected="true" aria-setsize="2" aria-posinset="1" target="_self" href="#" class="nav nav-tabs " id="tabPage4Tab2__'+nextTab+'">Tab '+(nextTab+1)+'<button class="close closeTab" type="button" onclick="deleteTab5(this)">×</button></a></li>').appendTo('#tabs_5');
...
$("#tabs_6").find('li').removeClass('eduClsActivePage6');
      $('<li id="liPage6_'+(nextTab+1)+'" onclick="selectCurrTab_6(this,event)" role="presentation" class="nav-item eduClsPage6 eduClsActivePage6"><a role="tab" aria-selected="true" aria-setsize="2" aria-posinset="1" target="_self" href="#" class="nav nav-tabs " id="tabPage6__'+nextTab+'">Reference '+(nextTab+1)+'<button class="close closeTab" type="button" onclick="deleteTab6(this)">×</button></a></li>').appendTo('#tabs_6');
